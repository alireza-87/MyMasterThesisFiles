...
\end{enumerate}
\glnote{you should expand point 5, by describing the logic/policy of how bins are selected/used (similarly to what you did for malloc in section 2.8, linking the corresponding section; moreover, it's probably better to re-order the section in the same order}
